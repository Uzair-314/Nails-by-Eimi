...
/**
 * The Menu + Categories navigation, shared by the mobile drawer and the
 * permanent desktop sidebar so both stay in step.
 *
 * Categories carrying a `children` array render as in-place accordions.
 */
